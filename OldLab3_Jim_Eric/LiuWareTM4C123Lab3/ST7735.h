...
// Prints Decimal:
// 1) device specifies top or bottom
// 2) line specifies line within screen division
// 3) value specifies integer to be printed. 
void ST7735_MessageDec(uint32_t device, uint32_t line, int32_t value);

// Prints Character:
// 1) device specifies top or bottom
// 2) line specifies line within screen division
// 3) value specifies String to be printed. 
...
void ST7735_Message2(uint32_t device, uint32_t line, char *string, int32_t value);

...
#include "../LiuWareTM4C123Lab3/FIFO.h"
...
void UART_Init(void){
  ...
  UART0_IBRD_R = 43;                    // IBRD = int(80,000,000 / (16 * 115,200)) = int(43.4028) | IBRD = int(50,000,000 / (16 * 115,200)) = int(27.1267)
  UART0_FBRD_R = 26;                     // FBRD = int(0.4028 * 64 + 0.5) = 26 | FBRD = int(0.126 * 64 + 0.5) = 8
...
void UART0_Handler(void){
  if(UART0_RIS_R&UART_RIS_TXRIS){       // hardware TX FIFO <= 2 items - RIS (Raw Interrupt Status) ???
